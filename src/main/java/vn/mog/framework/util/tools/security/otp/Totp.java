/**
 * JBoss, Home of Professional Open Source Copyright Red Hat, Inc., and individual contributors by
...
package vn.mog.framework.util.tools.security.otp;

import java.io.UnsupportedEncodingException;
import java.net.URLEncoder;
import java.security.InvalidKeyException;
import java.security.NoSuchAlgorithmException;
import vn.mog.framework.util.tools.security.otp.api.Base32;
import vn.mog.framework.util.tools.security.otp.api.Clock;
import vn.mog.framework.util.tools.security.otp.api.Digits;
import vn.mog.framework.util.tools.security.otp.api.Hash;
import vn.mog.framework.util.tools.security.otp.api.Hmac;
...
public class Totp {
  ...
  /**
   * Prover - To be used only on the client side Retrieves the encoded URI to generated the QRCode
   * required by Google Authenticator
   * 
