...
public class SummaryTransactionStatisticByDateDTO implements Serializable{
  ...
  private Map<String,SummaryDTO> summaryByDate;
//  private List<TransactionStatisticByDateDTO> details;
}
