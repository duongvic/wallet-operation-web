...
public class FindCustomerRequestType extends MobiliserRequestType {
  ...
  /*
   * public List<Integer> getStatusIds() { return statusIds; } public void
   * setStatusIds(List<Integer> statusIds) { this.statusIds = statusIds; }
   */
