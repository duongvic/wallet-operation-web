                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="page-header-left">
                            <ol class="breadcrumbs">
                                ...
                                <li><span class="nav-active"><spring:message
                                        code="menu.left.bill.senpay.tool"/></span></li>
                            ...
                            <form action="" method="GET" id="search-provider">
                                ...
                                <div>
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a
                                                href="${pageContext.request.contextPath}/provider/special/bill_senpay_tool/list">QL
                                            TÀI KHOẢN </a></li>
                                        <li>
                                            <a style="text-transform: uppercase;" href="${pageContext.request.contextPath}/provider/special/bill_senpay_tool/by-province/list">
                                        ...
                                        <div class="tab-pane active" id="tab_qltk">
                                                        ...
                                                        <div class="pull-right form-responsive bt-plt">
                                                            <sec:authorize
                                                                ...
                                                                <a class="mb-xs mt-xs btn btn-success"
                                                                   href="${contextPath}/provider/special/bill_senpay_tool/add"><i
                                            ...
                                            "
                                                        ...
                                                        <display:column title="${colAction}"
                                                            ...
                                                            <a href="${contextPath}/provider/special/bill_senpay_tool/details/${item.accountName}"
                                                               class="link-active"
