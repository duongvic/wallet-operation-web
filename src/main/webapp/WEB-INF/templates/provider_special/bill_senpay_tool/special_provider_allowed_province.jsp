                            ...
                            <form action="" method="GET" id="search-provider">
                                ...
                                <div>
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li><a href="${pageContext.request.contextPath}/provider/special/bill_senpay_tool/list">QL
                                            TÀI KHOẢN </a></li>
                                        <li class="active"><a style="text-transform: uppercase;"
                                                              href="${pageContext.request.contextPath}/provider/special/bill_senpay_tool/by-province/list">
