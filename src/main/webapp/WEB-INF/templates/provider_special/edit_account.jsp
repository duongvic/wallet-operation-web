                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="page-header-left">
                            <ol class="breadcrumbs">
                                ...
                                <li><span class="nav-active"><spring:message code="menu.left.provider.special"/></span>
                                </li>
                            ...
                            <div class="tab-content">
                                <div id="tab-list-customer-senPay" class="tab-pane active">
                                    ...
                                    <%--modelAttribute="customerDataForm"--%>
                                          action="${contextPath}${'edit' eq edit_type ? '/provider/special/bill_senpay/details/'.concat(account_object.accountName) : '/provider/special/bill_senpay/add'}">
