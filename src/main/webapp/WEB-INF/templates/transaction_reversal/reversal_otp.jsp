          ...
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="page-header-left">
              <ol class="breadcrumbs">
                ...
                <li><span><a href="<%=request.getContextPath()%>/v1/transference/processing" id="hight-title" class="hight-title"><spring:message code="wallet.transfer.process.nav.wallet.transfer"/> </a></span></li>
                    ...
                    <section class="panel panel-default">
                      <div class="panel-body edit_profile">
                        ...
                        <div class="form-group report_search_bt otp" style="text-align: center;">
                          ...
                          <spring:message code="common.btn.approve" var="btnApprove"/>
                          <input type="reset" class="submit_bt nomal_color_bk cancelBtn" name="cancel" value="${btnCancel }"/>
                          <input type="submit" class="submit_bt" name="submit" value="${btnApprove}"/>
                        </div>
                      </div>
                    </section>
                  <sec:csrfInput /></form>
