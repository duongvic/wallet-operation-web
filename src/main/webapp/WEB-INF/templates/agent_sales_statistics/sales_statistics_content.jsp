  ...
  <div class="panel-body pt-none">
    <form action="" method="GET" id="tbl-filter" class="mb-md">
      <div class="form-group ml-none mr-none">
        ...
        <select class="find-customer-saleChild" name="quickSearch" id="quickSearch" multiple="multiple">
        </select>
      </div>
    ...
    <jsp:include page="sales_statistics_table.jsp">
...
<script>
  $('.find-customer-saleChild').select2({
    width: "100%",
    dropdownAutoWidth: true,
    ajax: {
      url: ctx + "/ajax-controller/sale/find-customers",
      dataType: 'json',
      type: "POST",
