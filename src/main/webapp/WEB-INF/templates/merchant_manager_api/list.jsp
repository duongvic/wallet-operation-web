...
<%@ page import="static vn.mog.ewallet.operation.web.controller.epin.EpinPurchaseOrderAPIController.EPIN_PO_CONTROLLER" %>
<%@ page import="vn.mog.ewallet.operation.web.controller.epin.beans.EpinPurchaseOrderStatus" %>
<%@ page
    import="static vn.mog.ewallet.operation.web.controller.epin.EpinPurchaseOrderAPIController.EPIN_PO_DETAIL" %>
          ...
          <div class="col-xs-12">
            <div class="page-header-left">
              <ol class="breadcrumbs">
                ...
                <li><span class="nav-active"><spring:message code="service.exportcard.list.navigate.exportcard.api"/></span></li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="container-fluid">
          ...
          <section class="panel search_payment panel-default">
            <div class="panel-body pt-none">
              ...
              <spring:message var="titleStageSaleAppro" code="service.exportcard.list.tbl.col.stage.sale.approved"/>
              ...
              <display:table name="purchaseOrders" id="item"
                ...
                <display:column title="${colStage}" class="center" headerClass="center" style="min-width: 91px;">
                  <c:choose>
                    ...
                    <%--<c:when test="${item.stage == epinStageMerchantCancel}">--%>
                      ...
                      <%--&lt;%&ndash;<a title="${titleStageMerchantCancel}"><i class="fa fa-times reject_status"></i></a>&ndash;%&gt;--%>
                      <%--&lt;%&ndash;<a title="${titleStageExportAllowed}" class="status_number">4</a>&ndash;%&gt;--%>
                      <%--&lt;%&ndash;<a title="${titleStageFinish}" class="status_number">6</a>&ndash;%&gt;--%>
                    <%--</c:when>--%>

                    <c:when test="${item.stage == epinStageExportAllowed}">
                      <a title="${titleStageInit}"><i class="fa fa-check check_status"></i></a>
                      <a title="${titleStageSaleRejected}" class="status_number">1</a>
                      <a title="${titleStageSaleAppro}"><i class="fa fa-check check_status"></i></a>
                      <%--<a title="${titleStageMerchantCancel}" class="status_number">3</a>--%>
                      <%--<c:choose><c:when test="${perExportEpin}">--%>
                    ...
                    <%--<c:when test="${item.stage == epinStageFinished}">--%>
                      ...
                      <%--&lt;%&ndash;<a title="${titleStageFinish}"><i class="fa fa-check check_status"></i></a>&ndash;%&gt;--%>
                    <%--</c:when>--%>
                ...
                <display:column title="${colAction}" class="action_icon right" headerClass="right">
                  ...
                  <a href="${contextPath}<%=EPIN_PO_DETAIL%>?status=1&status=2&poMerchantId=${item.purchaseOrderId}"
                     title="${actionDetail}" class="detail-link link-active" poMerchantId="${item.purchaseOrderId }"><i class="fa fa-info-circle "></i></a>
