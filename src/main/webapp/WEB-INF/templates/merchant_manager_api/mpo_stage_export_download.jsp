...
<%@ page
        import="static vn.mog.ewallet.operation.web.controller.epin.EpinPurchaseOrderAPIController.EPIN_PO_CONTROLLER" %>
...
<section class="body">
  ...
  <c:url var="urlEpinList" value="<%=EpinPurchaseOrderAPIController.EPIN_PO_LIST%>"/>
