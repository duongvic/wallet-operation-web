          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div class="page-header-left">
                <ol class="breadcrumbs">
                  ...
                  <li><span><spring:message code="wallet.balance.balance.monitor"/></span></li>
                  <li><span><spring:message code="balance.customer.txn.nav.text"/></span></li>
                  <li><span class="nav-active"><spring:message code="balance.customer.txn.nav.detaitxn"/></span>
                  </li>
                </ol>
              </div>
          </div>
