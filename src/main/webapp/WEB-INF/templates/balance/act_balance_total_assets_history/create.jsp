          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="page-header-left">
              <ol class="breadcrumbs">
                ...
                <li><span class="nav-active">Thêm mới</span>
                </li>
              </ol>
            </div>
          </div>
        ...
        <div class="container-fluid">
          ...
          <section class="panel panel-default">
            <div class="panel-body">
              <form action="${contextPath}<%=BALANCE_TOTAL_OF_ASSETS_HISTORY_CREATE%>/using-post"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <select class="find-bankacc m-xs" data-plugin-selectTwo name="bankAccountIds"
                            id="bankAccountIds" style="width: 100%" disabled required>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <select name="balance-change" id="balance-change" class="form-control"
                      ...
                      <option value="CREDIT">Phát sinh tăng</option>
                      <option value="DEBIT">Phát sinh giảm</option>
                    </select>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-9 double-input">
                    ...
                    <input class="form-control" value="VND" style="width: 20%" disabled>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9 double-input">
                    <input class="form-control" style="margin-bottom: 5px; width: 80%"
                           name="balance"
                           onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                           id="balance" oninput="currencyPrice(event)" required>
                    <input class="form-control" value="VND" style="width: 20%" disabled>
                  </div>
                </div>
                <div class="form-group row">
...
<script type="text/javascript">
  // time picker -------------------------------------------------
  var time = new Date();
  var initial =  time.toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', second:'numeric', hour12: false });
