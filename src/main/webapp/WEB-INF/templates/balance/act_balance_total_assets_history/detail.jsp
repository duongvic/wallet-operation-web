            ...
            <div class="panel-body">
              ...
              <form class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-6 col-form-label">Thời điểm phát sinh giao dịch</label>
                  <div class="col-sm-6">
                    <p><fmt:formatDate pattern="HH:mm dd-MM-yyyy"
                                       value="${bankHistory.txnDate}"/></p>
                  </div>
                </div>

                <div class="form-group row">
                  <label class="col-sm-6 col-form-label">Thời điểm khởi tạo</label>
                  <div class="col-sm-6">
                    <p><fmt:formatDate pattern="HH:mm dd-MM-yyyy"
                                       value="${bankHistory.createdTime}"/></p>
                  </div>
                </div>

                <div class="form-group row">
                  <label class="col-sm-6 col-form-label">Ngân hàng</label>
                  <div class="col-sm-6">
                    <p>${bankHistory.bankCode}</p>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <p>${bankHistory.bankAccount}</p>
                  </div>
                </div>

                <div class="form-group row">
                  <label
                      class="col-sm-6 col-form-label">${bankHistory.txnType eq 'CREDIT'? 'Phát sinh tăng' : 'Phát sinh giảm'}</label>
                  <div class="col-sm-6">
                    <p>${ewallet:formatNumber(bankHistory.amount)}</p>
                  </div>
                </div>

                <div class="form-group row">
                  <label class="col-sm-6 col-form-label">Số dư tài khoản</label>
                  <div class="col-sm-6">
                    <p>${ewallet:formatNumber(bankHistory.postBalance)}</p>
                  </div>
                </div>

                <div class="form-group row">
                  <label class="col-sm-6 col-form-label">Mã tham chiếu</label>
                  <div class="col-sm-6">
                    <p>${bankHistory.bankRefTxn}</p>
                  </div>
                </div>

                <div class="form-group row">
                  <label class="col-sm-6 col-form-label">Nội dung</label>
                  <div class="col-sm-6">
                    <p>${bankHistory.info}</p>
                  </div>
                </div>
              </form>
            </div>
