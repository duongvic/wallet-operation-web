              ...
              <div class="tab-content">
                <div id="tab-list-customer" class="tab-pane active">
                  ...
                  <form id="${'edit' eq edit_type ? 'form-account-detail' : 'form-account-create'}"
                        ...
                        action="${contextPath}${'edit' eq edit_type ? '/staff-account/manage/details/'.concat(account_object.id) : '/staff-account/manage/add'}">
                    ...
                    <jsp:include page="edit_account_personal.jsp"/>

                    <hr/>
                    <!-- identity info -->
                    <%--<jsp:include page="edit_account_identity.jsp"/>--%>

                    <!-- edc -->
                    <jsp:include page="edit_account_edc.jsp"/>

                    <!-- Thuộc tính component -->
                    <jsp:include page="edit_account_attribute.jsp"/>

                    <jsp:include page="edit_account_roles.jsp"/>

                    <jsp:include page="edit_account_log_history.jsp"/>
...
//     img profile
    $('#identityIds_3').attr('disabled', false);

    $('#input-profie-image').attr('disabled', false);
