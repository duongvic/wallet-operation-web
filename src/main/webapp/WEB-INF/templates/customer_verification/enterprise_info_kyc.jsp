...
<div class="panel-body">
          ...
          <div id="div-selfie-image-kyc" class="col-sm-12 col-md-4">
            <div style="margin-bottom: 5px; height: 250px;" class="text-center">
              <img class="img-identity" alt=""
                   id="selfie-image"
                   src="${identityImgContent eq null ? imageDefault : identityImgContent}"
                   title="Cập nhập ảnh">
            </div>
            <span class="gb_La" id="lb-selfie-image">Cập nhập ảnh</span>
  ...
  <div class="row">
    <div class="form-group">
      <div class="col-sm-12 text-right">
        ...
        <c:if
            test="${customerVerifyKyc.requestStatusId != approvedKycRequest && customerVerifyKyc.requestStatusId != staffRejectKycRequest}">
  ...
  <script type="text/javascript">
    ...
    function executeUpdateImage(objProfileImage, input, imageType, event, idImageTag) {
      ...
      if (imageType === 2) {
        avatarStatusString = "Cập nhập ảnh";
