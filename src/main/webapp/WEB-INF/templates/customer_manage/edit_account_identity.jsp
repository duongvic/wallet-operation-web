    ...
    <div class="col-sm-6">
      <div class="col-sm-12 form-group" style="margin-bottom: 10px;">
        ...
        <div class="col-sm-8 double-input">
          <select class="form-control w100" data-plugin-selectTwo id="identity-type" name="identity-type" style="width: 100%">
      ...
      <div class="col-sm-12 form-group" style="margin-bottom: 10px;">
        ...
        <div class="col-sm-8 double-input">
          <input type="text" name="identity-number" id="identity-number" class="form-control w100" value="${identityDataForm.identityNumber}" placeholder="Identity number" style="width: 100%;">
        </div>
      </div>
      ...
      <div class="col-sm-12 form-group" style="margin-bottom: 10px;">
        ...
        <div class="col-sm-8 double-input">
          <input class="form-control" id="issue-date" data-inputmask="'alias': 'date'" name="issue-date"
                 placeholder="<spring:message code="account.identity.issue.date" />" title="<spring:message code="account.identity.issue.date" />"
      ...
      <div class="col-sm-12 form-group" style="margin-bottom: 10px;">
        <label class="col-sm-4 control-label nowrap"><spring:message code="account.identity.expire.date" />&nbsp;*</label>
        <div class="col-sm-8 double-input">
          <input class="form-control" id="expire-date" data-inputmask="'alias': 'date'" name="expire-date"
                 placeholder="<spring:message code="account.identity.expire.date" />" title="<spring:message code="account.identity.expire.date" />"
      ...
      <div class="col-sm-12 form-group" style="margin-bottom: 10px;">
        <label class="col-sm-4 control-label nowrap"><spring:message code="account.identity.placeof.issue"/>&nbsp;*</label>
        <div class="col-sm-8 double-input">
          <input type="text" name="place-of-issue" id="place-of-issue"  class="form-control" value="${identityDataForm.placeOfIssue}" placeholder="Place of issue" style="width: 100%;">
        </div>
      </div>
    </div>
      ...
      <div class="col-sm-12 form-group">
        ...
        <div class="col-sm-8 double-input">
          <div class="row">
            ...
            <style type="text/css">
              .img-identity {margin-bottom: 5px; height: 140px; width: 100%}
              img:hover {cursor: pointer;}
              .gb_La{background: rgba(134, 129, 129, 0.54);bottom: 5px;color: #fff;font-size: 9px;font-weight: bold;left: 15px;line-height: 9px;position: absolute;padding: 7px 0;text-align: center;width: 229px;}
              .gb_La:hover{cursor: pointer;}
            </style>
            <div class="col-sm-6">
              ...
              <c:if test="${isCustomerAgent || isMerchantUser}">
                ...
                <input type="hidden" id="identityIds_0" name="identityIds[0]" value="${identityDataForm.frontFaceImage.id}">
            ...
            <div class="col-sm-6">
              ...
              <c:if test="${isCustomerAgent || isMerchantUser}">
                ...
                <input type="hidden" id="identityIds_1" name="identityIds[1]" value="${identityDataForm.backFaceImage.id}">
            ...
            <div class="col-sm-6">
              ...
              <c:if test="${isCustomerAgent || isMerchantUser}">
                ...
                <input type="hidden" id="identityIds_2" name="identityIds[2]" value="${identityDataForm.selfieImage.id}">
