        ...
        <section role="main" class="content-body">
            ...
            <div class="content-body-wrap">
                <div class="container-fluid">
                    <c:set var="isCustomerActive"
                           value="${param.customerType == '1' or customerType == '1'}"/>
                    <c:set var="isAgentActive"
                           value="${param.customerType == '2' or customerType == '2'}"/>
                    <c:set var="isMerchantActive"
                           value="${param.customerType == '3' or customerType == '3'}"/>
                    <c:set var="isProviderActive"
                           value="${param.customerType == '11' or customerType == '11'}"/>
                    <c:set var="isPMSActive"
                           value="${param.customerType == '12' or customerType == '12'}"/>
                    <div class="tabs">
                        <ul class="nav nav-tabs">
                            <c:if test="${(permisAll) || (permisFinance) || (permisCSKH)}">
                                <li class=""><a onclick="openTabAll('');" href="#"
                                                data-toggle="tab">All</a></li>
                                <li class="${isCustomerActive ? 'active' : ''}"><a
                                        onclick="openTab('1');"
                                        href="#">Customer</a></li>
                                <li class="${isAgentActive ? 'active' : ''}"><a
                                        onclick="openTab('2');"
                                        href="#">Agent</a>
                                </li>
                                <li class="${isMerchantActive ? 'active' : ''}"><a
                                        onclick="openTab('3');"
                                        href="#">Merchant</a></li>
                                <li class="${isProviderActive ? 'active' : ''}"><a
                                        onclick="openTab('11');"
                                        href="#">Provider</a>
                                </li>
                                <li class="${isPMSActive ? 'active' : ''}"><a
                                        onclick="openTab('12');"
                                        href="#">Property Manager</a>
                                </li>
                            </c:if>
                                    ...
                                    <div class="panel-body pt-none">
                                        ...
                                        <form action="" method="GET" id="tbl-filter">
                                            ...
                                            <input type="hidden" id="customerType"
                                                   name="customerType"
                                                   value="${customerType == '' or customerType == null ? param.customerType : customerType}">
                                            <div class="form-group ml-none mr-none">
                                                <c:if test="${ (permisAll|| permisSale || permisCSKH) && customerType ne '12'}">
                                                    <div class='pull-right form-responsive bt-plt'>
                                                            <%--<c:if test="${param.customerType != null && '' ne param.customerType && '1' ne param.customerType }">--%>
                                                        <a class="mb-xs mt-xs btn btn-success"
                                                           href="${contextPath}/customer/manage/add${param.customerType != null ? '?customerType='.concat(customerType) : ''}"><i
