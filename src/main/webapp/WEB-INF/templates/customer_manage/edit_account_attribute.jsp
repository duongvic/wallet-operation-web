...
<div id="attribute_list">
    <div class="panel-title">
        ...
        <div class="panel-tools">
            <button
                    class="btn btn-sm btn-primary ${'edit' eq edit_type ? '' : 'hidden'}"
                    type="button"
                    ...
                    <td>
                        <select class="form-control"
                            ...
                            <c:forEach
                                    ...
                                    var="cus_attr_types">
                                <option
                                        value="${cus_attr_types.key}" ${cus_attr_types.key eq cus_attr.customerAttributeTypeId ? 'selected' : ''}>${cus_attr_types.value}</option>
                            </c:forEach>
                        </select>
                    </td>
