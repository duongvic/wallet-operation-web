    ...
    <section role="main" class="content-body">
      ...
      <div class="content-body-wrap">
        <div class="container-fluid">
          <div class="h4 mb-md">
            <spring:message code="fundout.history"/>
          </div>
<%--
          <c:set var="txnControlUri" scope="application">${contextPath}<%=FundOutController.FUND_OUT_HISTORY_CONTROLLER%></c:set>
--%>
          <jsp:include page="fund_out_content.jsp">
            <jsp:param name="permitSearchSales" value="${permitSearchSales || permitAll || permitFinance}"/>
            <jsp:param name="controlUri" value="${FundOutController.FUND_OUT_HISTORY_CONTROLLER}"/>
