...
<head>
  <!-- Basic -->
  <meta charset="UTF-8">
  <title><spring:message code="fundin.detai.title.page"/></title>
      ...
      <header class="page-header">
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <c:url var="urlFundInList" value="<%=FundInController.FUND_IN_HISTORY_LIST%>"/>

            <form action="${urlFundInList}" method="GET" id="search-fundin">
              ...
              <div class="page-header-left">
                <ol class="breadcrumbs">
                  ...
                  <li><span><a href="#"><spring:message code="fundin.detai.navigate.fundin"/></a></span></li>
                  <li><span><a href="#" id="hight-title" class="hight-title"><spring:message code="fundin.history"/></a></span></li>
                  <li><span class="nav-active"><spring:message code="fundin.detai.navigate.fundin.detail"/></span></li>
                </ol>
              </div>
            </form>
          </div>
        ...
        <div class="container-fluid">
          <div class="h4 mb-md">
            <spring:message code="transaction.api.navigate.transaction.detail"/>
					...
					<jsp:include page="fund-in-detail-info.jsp"/>

          <sec:authorize access="hasAnyRole('ADMIN_OPERATION',
            'SALESUPPORT_LEADER','SALESUPPORT_MANAGER','SALESUPPORT','TECH_SUPPORT',
