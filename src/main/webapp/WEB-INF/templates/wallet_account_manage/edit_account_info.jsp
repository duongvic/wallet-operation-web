    ...
    <div class="form-group">
      <div class="col-md-6 col-lg-6 col-sm-12">
        ...
        <spring:message
            ...
            var="last_name"/>
        <label class="col-md-4 col-lg-4  col-sm-4 control-label nowrap"><spring:message code="lable.last.first.name"/>&nbsp; *</label>
      ...
      <div class="col-md-6 col-lg-6 col-sm-12">
        <label class="col-md-5 col-lg-4 col-sm-4 control-label nowrap"><spring:message code="label.notification"/>&nbsp; *</label>
        <div class="col-md-7 col-lg-8 col-sm-8">
          <select class="form-control" id="notification"
            ...
            <c:forEach
              ...
              <option value="${notification_mode_id.key}" ${notification_mode_id.key eq account_object.notificationModeId ? 'selected' : ''}>
                <spring:message
  ...
  <div class="row">
    <div class="">
      <div class="col-md-6 col-lg-6 col-sm-12  form-group">
        <label class="col-md-4 col-lg-4 col-sm-4 control-label nowrap"><spring:message code="setting.account.notification.mode.EMAIL"/>&nbsp; *</label>
      ...
      <div class="col-md-6 col-lg-6 col-sm-12  form-group">
        <label class="col-md-5 col-lg-4 col-sm-4 control-label nowrap"><spring:message code="label.phone"/>*</label>
        <div class="col-md-7 col-lg-8 col-sm-8">
          <div class="input-group" style="width: 100%">
            <input class="form-control"
                   pattern="[0-9]{10,11}"
    ...
    <div class="form-group">
      <div class="col-md-6 col-lg-6 col-sm-12">
        <label class="col-md-4 col-lg-4 col-sm-4 control-label nowrap"
               for="customerType"><spring:message code="label.system.account.type"/>
          *</label>
      ...
      <div class="col-md-6 col-lg-6 col-sm-12">
        <label class="col-md-5 col-lg-4 col-sm-4 control-label nowrap"><spring:message code="account.dialog.blacklist.reason"/> </label>
        <div class="col-md-7 col-lg-8 col-sm-8">
          <select class="form-control"
            ...
            <c:forEach
                ...
                var="block_reason"
                varStatus="block_id">
              <option value="${block_reason.key}" ${account_object.blackListReason eq block_reason.key ? 'selected' : ''}>
                <spring:message
