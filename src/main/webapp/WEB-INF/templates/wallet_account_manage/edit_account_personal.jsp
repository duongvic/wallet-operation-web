...
<div class="panel-body">
  ...
  <div class="row">
    <div class="form-group">
      <div class="col-md-6 col-lg-6 col-sm-12">
        <label class="col-md-4 col-lg-4 col-sm-4 control-label nowrap"><spring:message code="account.info.store.address"/></label>
        <div class="col-md-7 col-lg-8  col-sm-8">
  ...
  <div class="row">
    <div class="form-group">
      <div class="col-sm-12 text-right" ${walletAccount eq accountType ? 'hidden' : ''}>
