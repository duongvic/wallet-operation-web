                ...
                <div class="container-fluid">
                    ...
                    <div class="tabs">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="${'5' == param.customerType ? 'active' : ''}">
                                <a onclick="openTab('5');" href="#">Zo-Ta</a>
                            </li>
                            <li class="${'6' == param.customerType ? 'active' : ''}">
                                <a onclick="openTab('6');" href="#">Pool</a>
                            </li>
                            <li class="${'7' == param.customerType ? 'active' : ''}">
                                <a onclick="openTab('7');" href="#">SOF</a>
                            </li>
                        </ul>
                                                ...
                                                <c:if test="${param.customerType != null && '' ne param.customerType}">
                                                    <sec:authorize
                                                        ...
                                                        <a class="mb-xs mt-xs btn btn-success"
                                                           href="${contextPath}/wallet-account/manage/add${param.customerType != null ? '?customerType='.concat(customerType) : ''}">
        ...
        /*cif*/
        {
          ...
          "render": function (data, type, full, meta) {
            ...
            var htmlCode = ''
                ...
                .concat('" href="${contextPath}/wallet-account/manage/details/')
        ...
        },
        {
          ...
          "render": function (data, type, full, meta) {
            ...
            var htmlCode = ""
                ...
                + "               href=\"${contextPath}/wallet-account/manage/details/" + data.id
                + "\">\n"
                + (displayName !== ""
...
//        {"data": "customerType.name"},
        /*loại khách hàng*/
        {
          "data": null,
          "render": function (data, type, full, meta) {
            var customerTypeName = data.customerType.name;
            var customerTypeNameLs = "";
            switch (customerTypeName) {
              case "POOL": {
                customerTypeNameLs = "POOL";
                break;
              }
              case "SOF": {
                customerTypeNameLs = "SOF";
                break;
              }
              case "TRUEMONEY": {
                customerTypeNameLs = "ZO-TA";
                break;
              }
              case "ZOTA": {
                customerTypeNameLs = "ZO-TA";
              ...
              default: {
                customerTypeNameLs = "N/A";
              }
            }

            var htmlCode = ""
                + "<div id=\"txn-customerTypeName-list-" + customerTypeName + "\" class=\""
                + "\">" + (customerTypeNameLs) + "</div>\n"
        ...
        },
        {
          ...
          "render": function (data, type, full, meta) {
            var htmlCode = ""
                ...
                + "    <input type=\"hidden\" id=\"user-" + data.id + "-blackListReason\" value=\""
                ...
                + "    </label>\n"
                + "    <a href=\"${contextPath}/wallet-account/manage/reset-password/" + data.id
                + "\"\n"
                + "       data-toggle=\"popover\"\n"
                + "       data-trigger=\"hover\"\n"
                + "       data-placement=\"top\"\n"
  ...
  function openTab(paramValue) {
    var searchURL = '${WalletAccountManageListUrl}' + '?menu=setting&customerType=' + paramValue;
    window.location.href = searchURL;
  }

  function openTabAll() {
    var searchURL = '${WalletAccountManageListUrl}?menu=setting';
    window.location.href = searchURL;
  }
</script>
</body>
