          ...
          <div class="col-xs-12">
            <div class="page-header-left">
              <ol class="breadcrumbs">
                ...
                <li><span class=""><spring:message code="balance.monitoring.table.wallet"/></span></li>
                <li><span class="nav-active"><spring:message code="menu.left.reconciliation"/></span></li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="tabs">
            ...
            <div class="tab-content pl-none pr-none">
              <div id="tab1" class="tab-pane active">
                ...
                <jsp:include page="reconciliation-content.jsp"/>
...
<script type="text/javascript">
  ...
  function openTab(paramValue) {
    ...
    if (window.location.search.indexOf("?") >= 0) {
      if (window.location.search.indexOf("idOwnerCustomerTypes") >= 0) {
        searchURL = '${prefixSearchReconciliationdUrl}' + replaceUrlParam(window.location.search, 'idOwnerCustomerTypes', paramValue);
      } else {
        searchURL = '${prefixSearchReconciliationdUrl}' + window.location.search + '&idOwnerCustomerTypes=' + paramValue;
      }
  ...
  function openTabAll() {
    ...
    if (window.location.search.indexOf("?") >= 0 && window.location.search.indexOf("idOwnerCustomerTypes") >= 0) {
        searchURL = '${contextPath}/wallet/balance-deduction-reconcilation-report/list-all' + replaceUrlParam(window.location.search, 'idOwnerCustomerTypes', '');
    } else {
