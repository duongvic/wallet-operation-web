...
<div class="modal fade bs-example-modal-lg" id="update-modal" role="dialog" aria-hidden="true" style="top: -10%;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="row form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-8">
                                    <input class="form-control" name="customerType2" id="customerType2" disabled>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-8">
                                    <input class="form-control" name="customerId2" id="customerId2" disabled>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-primary" id="update-btn" onclick="updateOneElement()"><spring:message code="button.update"/>
                </button>
