...
<div class="modal fade bs-example-modal-lg" id="add-revert-modal" role="dialog" aria-hidden="true" style="top: -10%;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-primary" id="add-revert-btn" onclick="addOneRevertElement()"><spring:message code="common.btn.add"/></button>
