                                        ...
                                        <div class="my-body">
                                            ...
                                            <div>
                                                <div class="cls_005"><span class="cls_005"
                                                                           style="font-weight: bold">I. ĐỐI SOÁT DỊCH VỤ PHONE TOPUP</span>
                                                </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="cls_008 col-md-3 col-xs-3">
                                                            <span class="cls_008" style="font-weight: bold"><fmt:formatNumber type="number" maxFractionDigits="3" value="${reconcil.getTotalNetAmount('PHONE_TOPUP')}" /> đồng ( Bao gồm VAT )</span>
                                                        </div>
                                                    </div>

                                                    <div class="cls_006"><span
                                                            class="cls_006">Số tiền bằng chữ: ${ewallet:numberToText(reconcil.getTotalNetAmount('PHONE_TOPUP'))} đồng</span>
                                                    </div>
                                                    <div class="row">
