                                ...
                                <section class="panel search_payment panel-default">
                                    <div class="panel-body pt-none">
                                        <div style="float: right" class="action_icon"><a target="_blank" title="In"
                                                                                         href="${contextPath}/wallet/reconcilation/print/bill-payment/${reconcil.id}"><i
                                        ...
                                        <div class="my-body">
                                            ...
                                            <div>
                                                <div class="cls_005"><span class="cls_005"
                                                                           style="font-weight: bold">I. ĐỐI SOÁT DỊCH VỤ BILL PAYMENT</span>
                                                </div>
                                                <c:forEach var="service" items="${reconcil.elementGroupByServiceType}"
                                                           varStatus="loop">
                                                    <c:choose>
                                                        <c:when test="${service.key eq 'BILL_PAYMENT'}">
                                                            <div>
                                                                <table>
                                                                    ...
                                                                    <c:forEach items="${service.value}" var="item"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="cls_007"
                                                                                ...
                                                                                <fmt:formatNumber type="number" maxFractionDigits="3" value="${item.unitCommissionFixedAmount}"/>
                                                                            </td>
                                                                            <td class="cls_007"
                                                                                style="text-align: right">
                                                                                <span><fmt:formatNumber type="number" maxFractionDigits="3" value="${item.numOfTrans}"/></span>
                                                                            </td>
                                                                            <td class="cls_007"
                                                                                style="text-align: right">
                                                                            ...
                                                                            <td class="cls_007"
                                                                                style="text-align: right">
                                                                                <span><fmt:formatNumber type="number" maxFractionDigits="3" value="${item.unitFeeFixedAmount}" /></span>
                                                                            </td>
                                                                            <td class="cls_007"
                                                                                style="text-align: right">
                                                                                <span><fmt:formatNumber type="number" maxFractionDigits="3" value="${item.sumOfFeeAmount}" /></span>
                                                                            </td>
                                                                            <td class="cls_007"
                                                                                style="text-align: right;">
                                                                                <span><fmt:formatNumber type="number" maxFractionDigits="3" value="${item.sumOfCommissionAmount}" /></span>
                                                                            </td>
                                                                        </tr>
                                                                    </c:forEach>
                                                                    <tr>
                                                                        ...
                                                                        <td class="cls_007"
                                                                            ...
                                                                            <span><fmt:formatNumber type="number" maxFractionDigits="3" value="${reconcil.getTotalNumOfTransaction('BILL_PAYMENT')}" /></span>
                                                                        </td>
                                                                        <td class="cls_007"
                                                                            style="text-align: right; font-weight: bold">
                                                                            <span><fmt:formatNumber type="number" maxFractionDigits="3" value="${reconcil.getTotalTransactionValue('BILL_PAYMENT')}" /></span>
                                                                        </td>
                                                                        <td></td>
                                                                        <td class="cls_007"
                                                                            style="text-align: right; font-weight: bold">
                                                                            <span><fmt:formatNumber type="number" maxFractionDigits="3" value="${reconcil.getTotalFeeAmount('BILL_PAYMENT')}" /></span>
                                                                        </td>
                                                                        <td class="cls_007"
                                                                            style="text-align: right; font-weight: bold">
                                                                            <span><fmt:formatNumber type="number" maxFractionDigits="3" value="${reconcil.getTotalCommissionAmount('BILL_PAYMENT')}" /></span>
                                                                        </td>
                                                                    </tr>
                                                                    <%--///////////////////////////////--%>
                                                                    <tr>
                                                                        <td class="cls_007" style="text-align: center; font-weight: bold">
                                                                            Giao dịch hủy/điều chỉnh (II)
                                                                        </td>
                                                                        <td></td>
                                                                        <td class="cls_007"
                                                                            style="text-align: right; font-weight: bold">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="cls_008 col-md-7 col-xs-7">
                                                            <span class="cls_008">Số tiền phí ${reconcil.contract.customerName} được hưởng:</span>
                                                        </div>
                                                        <div class="cls_008 col-md-5 col-xs-5">
                                                            <span class="cls_008" style="font-weight: bold"><fmt:formatNumber type="number" maxFractionDigits="3" value="${reconcil.getTotalEntitledFee('BILL_PAYMENT')}" /> đồng ( Bao gồm VAT )</span>
                                                        </div>
                                                    </div>

                                                    <div class="cls_006"><span
                                                            class="cls_006">Số tiền bằng chữ: ${ewallet:numberToText(reconcil.getTotalEntitledFee('BILL_PAYMENT'))} đồng</span>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-1 col-xs-1 flex-money">
                                                            <span class="cls_006"
                                                                  style="font-weight: bold"><fmt:formatNumber type="number" maxFractionDigits="0" value="${reconcil.getTotalEntitledFee('BILL_PAYMENT') / 1.1}" /></span>
                                                            <span class="cls_006"
                                                                  style="font-weight: bold"><fmt:formatNumber type="number" maxFractionDigits="0" value="${(reconcil.getTotalEntitledFee('BILL_PAYMENT') / 1.1) * 0.1}" /></span>
                                                        </div>
                                                    </div>
