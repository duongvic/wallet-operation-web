                          ...
                          <c:forEach items="${itemHash.value}" var="item"
                            ...
                            <tr
                              ...
                              <td style="text-align: right;">
                                ...
                                <c:set var="sumFacevalue"
                                       value="${sumFacevalue + (item.faceValue * item.quantity)}"
                                       scope="page"/></td>
                            </tr>
                          </c:forEach>
                          <tr>
                            <c:set var="tQuantity" value="${tQuantity + sumQuantity}" scope="page"/>
                            <c:set var="tFacevalue" value="${tFacevalue + sumFacevalue}"
                                   scope="page"/>
                            <td></td>
                            <td style="text-align: right;">
                              <b>${ewallet:formatNumber(sumQuantity)}</b></td>
                            <td style="text-align: right;">
                              <b>${ewallet:formatNumber(sumFacevalue)}</b></td>
                          </tr>
                          </tbody>
                      ...
                      <table
                        ...
                        <tr class="row-A">
                          ...
                          <td style="text-align: right; width: 30%;">
                            <b>${ewallet:formatNumber(tQuantity)}</b></td>
                          <td style="text-align: right; width: 30%;">
                            <b>${ewallet:formatNumber(tFacevalue)}</b>
                          </td>
                        </tr>
                        <tr class="row-B">
                          <td style="width: 20%;"><spring:message text=""
                                                                  code="report.mpo.detail.total.text"/></td>
                          <td style="text-align: right; width: 80%;" colspan="3"><b><c:out
                              value="${ewallet:numberToText(tFacevalue)}"></c:out> </b></td>
                        </tr>
                        </tbody>
                      </table>
                    </div>
