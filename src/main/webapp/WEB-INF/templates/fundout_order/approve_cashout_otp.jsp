              ...
              <div class="wizard-tabs">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="background-color: white;">
                  <div class="page-header-left header-title">
                    <spring:message code="fundout.title.page"/>&nbsp;<span class="primary_color">( <spring:message code="${fundInOrders.getTextOrderChannel()}"/> )</span>
                  </div>
                </div>
              </div>
                    ...
                    <form name="otpAuth" action="" method="post" >
                      ...
                      <section class="panel panel-default">
                        <div class="panel-body edit_profile">
                          ...
                          <div class="form-group report_search_bt otp" style="text-align: center;">
                            <input type="reset" class="submit_bt nomal_color_bk cancelBtn" name="cancel" value="Hủy"/>
                            <input type="submit" class="submit_bt" name="submit" value="Approve"/>
                          </div>
                        </div>
                      </section>
                    <sec:csrfInput /></form>
