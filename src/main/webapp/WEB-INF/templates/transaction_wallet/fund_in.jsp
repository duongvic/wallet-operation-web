            ...
            <div class="page-header-left">
              <ol class="breadcrumbs">
                ...
                <li><span class="nav-active"><spring:message
                    code="fundin.navigate.fundin.history"/></span></li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="tabs">
            <c:if test="${permitAll}">
              <ul class="nav nav-tabs">
                <li class=""><a onclick="openTab('all');" href="#" data-toggle="tab">All</a>
                </li>
...
--%>
                <jsp:include page="../fundin/fund_in_content.jsp">
...
<spring:message var="fundInSourceLabel" code="select.fundin.source.of.fund.type"/>
<jsp:include page="../include_component/search_form_commons.jsp">
  ...
  <jsp:param name="selWalletSourceOfFundLabel" value="${fundInSourceLabel}"/>
</jsp:include>
