            ...
            <form name="edit" id="edit-form">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title ttitle" id="myModalLabel"><spring:message
                            code="provider.edit.title.edit.information"/>&nbsp;<span id="serviceName"></span></h4>
                </div>
                <div class="modal-body">
                    ...
                    <div>
                        <span style="text-transform: uppercase;"><b><spring:message code="system.service.detail.summary.row.description"/></b></span>
