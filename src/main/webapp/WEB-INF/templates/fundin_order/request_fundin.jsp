        ...
        <section role="main" class="content-body">
            ...
            <div class="content-body-wrap">
                <div class="container-fluid">
                    <div class="h4 mb-md">
                        <spring:message code="fundin.list.rechargeMethod"/>
                    </div>
                    <section class="panel search_payment panel-default">
                        <div class="panel-body pt-none pb-none">
                            <div class="form-group">
                                ...
                                <sec:authorize
                                        access="hasAnyRole('ADMIN_OPERATION','MERCHANT','CUSTOMER','SALE_EXCUTIVE','FA_MANAGER','FINANCE_LEADER','FINANCESUPPORT_LEADER','FINANCE_SUPPORT','FINANCE')">
                                    <div class="col-xs-2 center col-respon">
                                        <a href="#" class="i-flag" id="bank_tranfer">
                                            <div class="sprite-fundin-i_bank_charging img-responsive ml-xs"></div>
                                ...
                                <sec:authorize
                                        access="hasAnyRole('ADMIN_OPERATION','MERCHANT','CUSTOMER','SALE_DIRECTOR','FA_MANAGER','FINANCE_LEADER','FINANCESUPPORT_LEADER','FINANCE_SUPPORT','FINANCE')">
                                    <!--disabled cash on hand-->
                                    <%--                                                                        <div class="col-xs-2 center col-respon">--%>
                                    <%--                                                                            <a href="#" class="i-flag" id="cash_on_hand">--%>
                                    <%--                                                                                <div class="sprite-fundin-i_api_otp img-responsive ml-xs"></div>--%>
                                    <%--                                                                                <p class="mb-none"><strong><spring:message--%>
                        ...
                        <!-- bank transfer -->
                        <jsp:include page="request_bank_transfer.jsp"/>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('input:file').change(function (click) {
