...
(function(theme, $) {
	...
	var $body		= $( 'body' ),
		...
		isIOS = navigator.userAgent.toLowerCase().indexOf('ios') > -1;

	// mobile devices with fixed has a lot of issues when focus inputs and others...
  if ( typeof $.browser !== 'undefined' && $.browser.mobile && $html.hasClass('fixed') /*[[*/ && $( window ).width() < 767 /*]]*/)  //768
	{
...
//		customScroll: ( !Modernizr.overflowscrolling && !isAndroid && $.fn.nanoScroller !== 'undefined'),
        ...
        isOpened: $html.hasClass( 'sidebar-left-opened' )
			};
      ...
      if ( typeof $.browser !== 'undefined' && $.browser.mobile  && $( window ).width() < 767) { //fix scroll (768)
		...
		events: function() {
			...
			if ( typeof $.browser !== 'undefined' && !this.customScroll && isAndroid  && isIOS) {
				this.fixScroll();
			}
...
(function($) {
	...
	if ( $.isFunction( $.fn[ 'dataTable' ] ) ) {
		...
		$.extend(true, $.fn.dataTable.defaults, {
            ...
            language: {
                "emptyTable": "Không có kết quả hiển thị"
            },
            paging:false,
            info:false,
