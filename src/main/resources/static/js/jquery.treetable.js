+function ( $ ) {
        ...
        return this.each( function () {
            ...
            if ( ! data ) {
                $this.data(
                    ...
                    new TreeTable(
                        this,
                        $.extend(true, $.fn.treeTable.defaults, typeof options == 'object' ? options : {} )
                    ));
            }
        });
    }
    ...
    TreeTable.prototype.addDepth = function ( nodes ) {
        ...
        nodes.each( function ( idx, node ) {
            ...
            var depth = ( pnodeId && pnodeId in self.depths ) ? self.depths[ pnodeId ] + 1 : 0;
        ...
        nodes.each( function ( idx, node ) {
            ...
            if ( self.children[ nodeId ] > 0 ) {
                $( TT.expanderTemplate )
                    ...
                    .addClass( (self.options.startCollapsed) ? self.options.collapsedClass : self.options.expandedClass );
                $node.addClass( (self.options.startCollapsed) ? TT.collapsed : TT.expanded );
    ...
    $.fn.treeTable.defaults = {
        ...
        expandedClass: 'fa fa-angle-down fa-lg',
        collapsedClass: 'fa fa-angle-right fa-lg'
    };
